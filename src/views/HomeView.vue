    ...
    <section class="bg-blue-50 py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="bg-white rounded-lg p-6 text-center shadow-sm">
            <div class="text-3xl font-bold text-green-600 mb-2">{{ stats.done }}</div>
            <div class="text-gray-600">Completed</div>
          </div>
          <div class="bg-white rounded-lg p-6 text-center shadow-sm">
            <div class="text-3xl font-bold text-yellow-600 mb-2">{{ stats.inProcess }}</div>
            <div class="text-gray-600">In Progress</div>
          </div>
          <div class="bg-white rounded-lg p-6 text-center shadow-sm">
            <div class="text-3xl font-bold text-blue-600 mb-2">{{ stats.completionRate }}%</div>
    ...
    <section class="py-16 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <p class="mt-4 text-lg text-gray-600">Recent additions to our assessment collection</p>
        </div>
    ...
    <section class="py-16 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
          ...
          <p class="mt-4 text-lg text-gray-600">Modern assessment platform built for efficiency</p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div class="text-center">
            ...
            <p class="text-gray-600">Comprehensive review process ensures high-quality assessments</p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600">Built with modern technology for optimal performance</p>
          </div>
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600">Intuitive interface designed for ease of use</p>
          </div>
        </div>
      </div>
    </section>
